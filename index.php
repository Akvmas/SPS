      ...
      <div class="container">
        ...
        <div class="login-wrap p-0">
          <div class="form-group">
            ...
            <button name="Formulaires FON" class = "form-control btn btn-primary submit px-3" id = "FormulaireFON"value="Formulaire" onclick="self.location.href='FormulairesFON/FormulairesFON.php'">Fiche d'observation ou de notification</button>
          </div>
          <div class="container">
            <div class="login-wrap p-0">
              <div class="form-group">

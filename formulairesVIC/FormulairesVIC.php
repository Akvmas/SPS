        ...
        <div class="formbold-main-wrapper">
            <div class="formbold-form-wrapper">
                ...
                <div class="flex flex-wrap formbold--mx-3">
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5 w-full">
                            Base vie mobile <input type="checkbox" name="Base vie mobile[]" id="Base vie mobile" />
                        </div>
                    </div>
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5 w-full">
                    ...
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5 w-full">
                            Bungalow chantier <input type="checkbox" name="Bungalow chantier[]" id="Bungalow chantier" />
                        </div>
                    </div>
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5 w-full">
                    ...
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5 w-full">
                            Repas pris au restaurant <input type="checkbox" name="Repas pris au restaurant[]" id="Repas pris au restaurant" />
                        </div>
                    </div>
                    <div class="w-full sm:w-half formbold-px-3">
                        <div class="formbold-mb-5">
                ...
                <br>
                <br>
                <h3><strong>Risques</strong></h3> </br>
                <br>
                <div class="formbold-mb-5 ">
